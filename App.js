...
export default function App() {
  ...
  const loadStoredData = async () => {
    try {
      ...
      const pinEnabledStored = await AsyncStorage.getItem(
        '@sanita_pin_enabled'
      );
      ...
      const pinStored = await AsyncStorage.getItem(
        '@sanita_custom_pin'
      );
  ...
  const saveNewCustomPin = async () => {
    if (!tempNewPin || tempNewPin.length < 3) {
      Alert.alert(
        'تنبيه',
        'برجاء إدخال رمز سري مكون من 3 أرقام على الأقل'
      );
    ...
    try {
      ...
      Alert.alert(
        'نجاح',
        'تم حفظ وتحديث الرمز السري بنجاح 🔒'
      );
    } catch (e) {}
  };
  ...
  const handleAddShipment = () => {
    if (!driverName || !destination) {
      Alert.alert(
        'تنبيه',
        'برجاء ملء اسم السائق والوجهة على الأقل لحفظ الشحنة'
      );
    ...
    const newShipment = {
      ...
      clientPhone:
        clientPhone || DEFAULT_TARGET_WA,

      // حالة الشحنة
      status: 'في الطريق',

      // ملاحظات السائق
      driverNotes: shipmentNotes
        ? shipmentNotes.trim()
        : '',
  ...
  // إثبات التسليم
  const confirmDeliveryProof = (shipment) => {
    Alert.alert(
      '📦 إثبات التسليم',
      'هل تم تسليم الشحنة بالفعل؟',
      [
        {
          text: 'إلغاء',
          style: 'cancel'
        },
        {
          ...
          onPress: () => {
            ...
            Alert.alert(
              'تم بنجاح ✅',
              'تم تسجيل إثبات تسليم الشحنة بنجاح.'
            );
          }
        }
      ]
  ...
  // أرقام مهمة - مؤقتة
  const showImportantNumbers = () => {
    Alert.alert(
      '☎️ أرقام مهمة',
      '🚧 جاري العمل على هذه الخاصية\n\nسيتم إضافة أرقام التواصل المهمة للسائقين قريبًا.',
      [
        {
          text: 'حسناً'
        }
  ...
  const handleSendStatus = (
    ...
    let targetNumber = s.clientPhone
      ? s.clientPhone.trim()
      : DEFAULT_TARGET_WA;
  ...
  const handleExportAllReport = () => {
    ...
    const url =
      `https://api.whatsapp.com/send?phone=${cleanPhone}&text=${encodeURIComponent(reportText)}`;
    ...
    >
      ...
      {!isOnline && (
        ...
        >
          ...
          >
            ⚠️ تنبيه: لا يوجد اتصال بالإنترنت حالياً
          </Text>
        </View>
      )}
      ...
      >
        ...
        >
          ...
          >
            دليل مخازن وشركات الأونلاين والبنوك بمصر
          </Text>
        </View>
            ...
            >
              ...
              >
                <View>
                  ...
                  >
                    تفعيل الثيم المظلم المريح للعين
                  </Text>
                </View>
              ...
              >
                <View>
                  ...
                  >
                    تفعيل كلمة سر خاصة لفتح السجلات
                  </Text>
                </View>
              ...
              {customPinEnabled && (
                ...
                >
                  <Text
                    style={
                      styles.changePinBtnText
                    }
                  >
                    🔑 تغيير الرمز السري الخاص بي
                  </Text>
                </TouchableOpacity>
              )}
              ...
              >
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      Linking.openURL(
                        `https://wa.me/2${DEVELOPER_PHONE}`
                      )
                    }
                  >
                    <Text
                      style={
                        styles.drawerBtnText
                      }
                    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              اكتب الرمز السري الجديد الذي تريده لحماية الشحنات:
            </Text>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              هذا القسم محمي، أدخل الرمز السري الخاص بك للمتابعة:
            </Text>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              اختر الحالة الحالية للشحنة:
            </Text>

            {[
              'في الطريق',
              'وصل للمخزن',
              'جاري التحميل / التفريغ',
              'تم التسليم',
              'يوجد مشكلة'
            ].map(
              (
      ...
      'about' ? (
        ...
        >
          ...
          >
            ...
            >
              شركة سانيتا تهدف إلى تقديم حلول عملية ومبتكرة
              في مجال الخدمات اللوجستية وإدارة ومتابعة الشحنات.
            </Text>
            ...
            >
              تم تطوير تطبيق Sanita Location لتسهيل الوصول
              إلى مواقع المخازن والشركات ومراكز التوزيع،
              بالإضافة إلى تنظيم بيانات الشحنات ومتابعتها
              بطريقة بسيطة وسريعة.
            </Text>
            ...
            >
              جميع الحقوق محفوظة لشركة سانيتا.
            </Text>
            ...
            >
              <Text
                style={
                  styles.backAboutBtnText
                }
              >
                ← العودة للمخازن والبنوك
              </Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
